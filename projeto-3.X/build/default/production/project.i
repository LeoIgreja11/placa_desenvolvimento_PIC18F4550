...
void main(void) {
    ...
    while(1){
        ...
        pwmSinal = ((porcentagem) / 100) * (PR2+1) * 4;
        ...
        temperatura = (((float)adc*5/1023)/0.01) / 2;


        CCPR1L = pwmSinal >> 2;
        CCP1CONbits.DC1B1 = (pwmSinal >> 1) & 0x01;
        CCP1CONbits.DC1B0 = (pwmSinal) & 0x01;
        ...
        LCD_Clear();
        sprintf(buffer,"%0.1f", porcentagem);
