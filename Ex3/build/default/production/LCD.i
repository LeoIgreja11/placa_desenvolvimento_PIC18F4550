...
static void Nibble(uint8_t nibble){
    LATBbits.LATB3 = (nibble & 0b00001000) >> 3;
    LATBbits.LATB2 = (nibble & 0b00000100) >> 2;
    LATBbits.LATB1 = (nibble & 0b00000010) >> 1;
    LATBbits.LATB0 = (nibble & 0b00000001) >> 0;
    enable();
}
...
void LCD_Init(void){
    ...
    LATBbits.LATB0 = 1;
    enable();
    _delay((unsigned long)((4500)*(20000000/4000000.0)));
    ...
    LATBbits.LATB0 = 1;
    enable();
    _delay((unsigned long)((120)*(20000000/4000000.0)));
...
void LCD_Blink(void){
    LCD_Cmd(0b00001110 | 0b00000001);
}

void LCD_noBlink(void){
    LCD_Cmd(0b00001110 | 0b00000000);
}
